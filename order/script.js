const orders = [
    { id: 1, customer: "Abraham", status: "Pending",items: ["Laptop", "Phone"] },
    { id: 2, customer: "Sans Smith", status: "Shipped", items: ["Tablet", "Headphones"] },
    { id: 3, customer: "John", status: "Delivered", items: ["Earbuds", "Tripod"] },
    { id: 4, customer: "Rohan", status: "Delivered", items: ["Camera", "Tripod"] },
  ];
